...
cordova.define("salesforce/util/bootstrap", function(require, exports, module) {
    ...
    var loginSuccess = function(oauthCredentials) {
        ...
        var eventInfo = event.EventType.STARTING;
        eventInfo.oauthCredentials = oauthCredentials;
        event.sendStatusEvent(eventInfo);
        if (!startData.noRedirect) loadUrl(fullAppUrl);
    };
