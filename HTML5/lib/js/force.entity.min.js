...
a.cache){var b={describeResult:a._describeResult,metadataResult:a._metadataResult};b[a.cache.keyField]=a.sobjectType;return a.cache.save(b)}},k=function(){if(!a._describeResult)return c=!1,h.describe(a.sobjectType).then(function(b){a._describeResult=b})},g=function(){if(!a._metadataResult)return c=!1,h.metadata(a.sobjectType).then(function(b){a._metadataResult=b})};return{describe:function(){a=this;return a._describeResult?m.when(a._describeResult):m.when(b()).then(k).then(d).then(function(){return a._describeResult})},
getMetadata:function(){a=this;return a._metadataResult?m.when(a._metadataResult):m.when(b()).then(g).then(d).then(function(){return a._metadataResult})},reset:function(){a=this;c=!1;a._metadataResult=a._describeResult=void 0;return m.when(clearCache())}}}());e.syncSObjectWithCache=function(a,c,b,d,k,e,n){console.log("---\x3e In Force.syncSObjectWithCache:method="+a+" id="+b);n=n||!1;c=e.isLocalId(b);var f=null;switch(a){case "create":a=g.extend(d,{Id:n?e.makeLocalId():b,__locally_created__:n,__locally_updated__:!1,
__locally_deleted__:!1});f=e.save(a);break;case "read":f=e.retrieve(b,k).then(function(a){return a});break;case "update":a=g.extend(d,{Id:b,__locally_created__:c,__locally_updated__:n,__locally_deleted__:!1});f=e.save(a);break;case "delete":f=!n||c?e.remove(b):e.retrieve(b).then(function(a){return e.save(g.extend(a,{__locally_deleted__:!0}))}).then(function(){return null})}return f};e.syncSObjectWithServer=function(a,c,b,d,e,f,n){console.log("---\x3e In Force.syncSObjectWithServer:method="+a+" id="+
b);var z=function(a){return h.retrieve(c,a.Id,n)},l=null;switch(a){case "create":b=g.pick(d,e);l=h.create(c,g.omit(b,"Id")).then(function(a){return g.extend(d,{Id:a.id})});break;case "read":l=h.retrieve(c,b,e);break;case "update":a=g.pick(d,e);l=h.update(c,b,g.omit(a,"Id")).then(function(){return d});break;case "delete":l=h.del(c,b).then(function(){return null})}f&&(l=l.then(z));return l};e.CACHE_MODE={CACHE_ONLY:"cache-only",CACHE_FIRST:"cache-first",SERVER_ONLY:"server-only",SERVER_FIRST:"server-first"};
e.syncSObject=function(a,c,b,d,g,f,n,h,l){console.log("--\x3e In Force.syncSObject:method="+a+" id="+b+" cacheMode="+l);var j=function(a,b){return e.syncSObjectWithServer(a,c,b,d,g,f,n)};if(null==h||l==e.CACHE_MODE.SERVER_ONLY)return j(a,b);if(null!=h&&l==e.CACHE_MODE.CACHE_ONLY)return e.syncSObjectWithCache(a,c,b,d,null,h,!0);var p=null,m=!1;if(l==e.CACHE_MODE.CACHE_FIRST)p=e.syncSObjectWithCache(a,c,b,d,g,h,void 0).then(function(c){m=null!=c;return!m?j(a,b):c});else if(l==e.CACHE_MODE.SERVER_FIRST||
null==l)if(h.isLocalId(b)){if("read"==a||"delete"==a)throw"Can't "+a+" on server a locally created record";var s,p=j("create",null).then(function(a){s=a;return e.syncSObjectWithCache("delete",c,b,void 0,void 0,h,void 0)}).then(function(){return s})}else p=j(a,b);return p=p.then(function(d){return!m?e.syncSObjectWithCache("read"==a?"update":a,c,"delete"==a?b:d.Id,d,void 0,h,void 0):d})};e.MERGE_MODE={OVERWRITE:"overwrite",MERGE_ACCEPT_YOURS:"merge-accept-yours",MERGE_FAIL_IF_CONFLICT:"merge-fail-if-conflict",
MERGE_FAIL_IF_CHANGED:"merge-fail-if-changed"};e.syncSObjectDetectConflict=function(a,c,b,d,k,f,n,j,l,q,p){console.log("--\x3e In Force.syncSObjectDetectConflict:method="+a+" id="+b+" cacheMode="+l+" mergeMode="+p);var r=function(d){return e.syncSObject(a,c,b,d,k,f,n,j,l)};if(null==q)return r(d);var s=function(a){return l==e.CACHE_MODE.CACHE_ONLY||a.__local__?a:q.save(a)},t=function(){return l==e.CACHE_MODE.CACHE_ONLY?null:q.remove(b)},w=function(a,b){return g.filter(g.intersection(k,g.union(g.keys(a),
g.keys(b))),function(c){return(a[c]||"")!=(b[c]||"")})},u=function(){var a;return p==e.MERGE_MODE.OVERWRITE||null==p||l==e.CACHE_MODE.CACHE_ONLY||null!=j&&j.isLocalId(b)?r(d):q.retrieve(b).then(function(d){a=d;return null==a?null:h.retrieve(c,b,k||["Id"])}).then(function(b){var c=!1;if(null==b||null==a)return r(d);var f=w(a,d),k=w(d,b),h=w(a,b),k=g.intersection(h,f,k),j=g.difference(h,k);switch(p){case e.MERGE_MODE.MERGE_ACCEPT_YOURS:c=!1;break;case e.MERGE_MODE.MERGE_FAIL_IF_CONFLICT:c=0<k.length;
break;case e.MERGE_MODE.MERGE_FAIL_IF_CHANGED:c=0<h.length}if(c)return b={conflict:!0,base:a,theirs:b,yours:d,remoteChanges:h,localChanges:f,conflictingChanges:k},m.Deferred().reject(b);b=g.extend(d,g.pick(b,j));return r(b)})},v=null;switch(a){case "create":v=r(d).then(s);break;case "read":v=r(d).then(s);break;case "update":v=u().then(s);break;case "delete":v=u().then(t)}return v};e.fetchSObjectsFromCache=function(a,c){console.log("---\x3e In Force.fetchSObjectsFromCache");return a.find(c)};e.fetchSObjectsFromServer=
function(a){console.log("---\x3e In Force.fetchSObjectsFromServer:config="+JSON.stringify(a));var c=function(a){return h.query(a).then(function(a){var b=a.nextRecordsUrl;return{totalSize:a.totalSize,records:a.records,hasMore:function(){return null!=b},getMore:function(){var a=this;return!b?null:h.queryMore(b).then(function(c){b=c.nextRecordsUrl;a.records.pushObjects(c.records);return c.records})},closeCursor:function(){return m.when(function(){b=null})}}})},b=null;switch(a.type){case "soql":b=c(a.query);
break;case "sosl":b=h.search(a.query).then(function(a){return{records:a,totalSize:a.length,hasMore:function(){return!1}}});break;case "mru":var d=a.sobjectType,e=a.fieldlist,b=h.metadata(d).then(function(a){return e?(a="SELECT "+e.join(",")+" FROM "+d+" WHERE Id IN ('"+g.pluck(a.recentItems,"Id").join("','")+"')",c(a)):{records:a.recentItems,totalSize:a.recentItems.length,hasMore:function(){return!1}}})}return b};e.fetchSObjects=function(a,c,b){console.log("--\x3e In Force.fetchSObjects:config.type="+
